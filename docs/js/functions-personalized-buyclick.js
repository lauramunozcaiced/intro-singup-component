...
//4.3.1 Busca los nombres de las tiendas y Agrega los títulos en la tabla: 
  jQuery(hidden_products).each(function(n){
	  ...
	  if(exist_store != true){
		  jQuery(visible_products_tbody).append('<tr id="store_'+n+'" class="store_block" data-name="'+jQuery(this).find(hidden_product_title).text()+'"><h3 class="store_title">'+jQuery(this).find('.variation a.wcfm_dashboard_item_title').text()+'</h3></tr>'); 
	  }
  });
//4.3.1 END
